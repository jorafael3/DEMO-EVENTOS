...
const miseventos = React.lazy(() => import('./views/miseventos'))
...
const routes = [
  ...
  { path: '/incidencias', name: 'Eventos', element: Incidencias },
  { path: '/incidencias/DetalleEvento', name: 'DetalleEvento', element: DetalleEvento },
  { path: '/miseventos', name: 'mis eventos', element: miseventos },
